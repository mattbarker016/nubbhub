...
class GuestData {
    ...
    func monthZero() -> Nubb {
        ...
        let device4 = Device(id: "b4:44:d9:10:db:76", name: "iPhone 5", color: UIColor.yellowColor(), totalIn: 10169, totalOut: 3020, totalUsage: 16919)
        let device5 = Device(id: "b4:44:d9:10:db:76", name: "iPhone 7", color: UIColor.purpleColor(), totalIn: 12169, totalOut: 2850, totalUsage: 16269)
        let device6 = Device(id: "b4:44:d9:10:db:76", name: "Apple Watch Sport", color: UIColor.orangeColor(), totalIn: 17169, totalOut: 2050, totalUsage: 18919)
        let device7 = Device(id: "b4:44:d9:10:db:76", name: "Apple I", color: UIColor.magentaColor(), totalIn: 10169, totalOut: 1890, totalUsage: 16919)
        
        return Nubb(totalUsage: 149069, totalIn: 78330, totalOut: 12734, devices: [device1, device2, device3, device4, device5, device6, device7], billingRate: 0.0015, dataCap: 153600)
    }
